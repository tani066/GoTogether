...
export async function middleware(req) {
  ...
  if (token && !token.profileComplete && pathname !== '/profile-setup') {
    return NextResponse.redirect(new URL('/profile-setup', req.url));
  }

  // If user is authenticated and profile is complete, but they are trying to access setup, redirect to dashboard
  if (token && token.profileComplete && pathname === '/profile-setup') {
